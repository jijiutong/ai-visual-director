...
| `compact/` | `/compact` | Token 压缩 — Prompt压缩/上下文管理/去噪 |
...
9. 用户说 `/compact`、压缩、去噪 → 路由到 `compact/SKILL.md`
...
/compact     → 读取 state/variable-registry + state/visual-control-state；更新 visual-control-state
```
